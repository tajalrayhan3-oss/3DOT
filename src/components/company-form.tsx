...
export function CompanyForm() {
  ...
  useEffect(() => { void (async () => {
    ...
    if (!user) return;
    const { data } = await supabase.from("companies").select("id,name,trn,city,email,phone,address,website,logo_url,letterhead_url,signature_url,stamp_url,document_footer").eq("owner_id", user.id).maybeSingle();
